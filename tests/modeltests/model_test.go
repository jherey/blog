...
import (
	...
	"github.com/jherey/blog/api/controllers"
...
func TestMain(m *testing.M) {
	var err error
	err = godotenv.Load(os.ExpandEnv("../../.env")) // load .env file
	if err != nil {
		log.Fatalf("Error getting env")
	}
	Database()
...
func Database() {
	...
	if TestDbDriver == "postgres" {
		...
		if err != nil {
			...
			fmt.Printf("We are connected to the %s database yaaay\n", TestDbDriver)
		}
	}
}
